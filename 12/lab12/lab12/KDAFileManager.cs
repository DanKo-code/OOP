...
namespace lab12
{
    internal class KDAFileManager
    {
        ...
        {
            CreateDirectory("C:\\2курс, 1 сем\\ООП\\12\\KDAFiles");
            ...
            if (directoryInfo.Exists)
            {
                foreach (var file in directoryInfo.GetFiles())
                {
                    ...
                    {
                        file.CopyTo("C:\\2курс, 1 сем\\ООП\\12\\KDAFiles\\" + file.Name);
                    }
                }
            }
        }
        ...
        public static void FindInformationFromDay(int dayUser, int hour,int action)
        {
            ...
            using (var stream = new StreamReader(@"C:\2курс, 1 сем\ООП\12\KDAlogfile.txt"))
            {
